 ...
 implements LibraryServiceOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("simulateSoftwareBug", new java.lang.Integer (9));
    _methods.put ("simulateCrash", new java.lang.Integer (10));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 9:  // LibraryService/simulateSoftwareBug
       {
         String userId = in.read_string ();
         String $result = null;
         $result = this.simulateSoftwareBug (userId);
         out = $rh.createReply();
         out.write_string ($result);
         break;
       }

       case 10:  // LibraryService/simulateCrash
       {
         String userId = in.read_string ();
         String replicaName = in.read_string ();
         String $result = null;
         $result = this.simulateCrash (userId, replicaName);
         out = $rh.createReply();
         out.write_string ($result);
         break;
       }
